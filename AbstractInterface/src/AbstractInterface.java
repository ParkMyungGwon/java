...
public class AbstractInterface {
	...
	public static void main(String[] args) {
		...
		storage.addPersonalInfo("김기동", "950923-1078888");
		storage.addPersonalInfo("장선영", "985555-1515151");
		
		System.out.println(storage.searchName("950923-1078888"));
		System.out.println(storage.searchName("985555-1515151"));
	}
